...
<!------ Include the above in your HEAD tag ---------->
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <form id="logout-form" action="{{ route('logout') }}" method="POST" class="button">
          @csrf
          ...
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="/invoice">Tambah Invoice</a></li>
                  <li><a class="dropdown-item" href="/viewinvoice">List Invoice</a></li>
                </ul>
              </li>
              ...
              <div class="card-body">
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="/adminlte/dist/img/user2-160x160.jpg" alt="message user image">
                    <!-- /.direct-chat-img -->
                ...
                <div class="direct-chat-contacts">
                  <ul class="contacts-list">
                    <li>
                      <a href="#">
                        <img class="contacts-list-img" src="/adminlte/dist/img/user2-160x160.jpg" alt="User Avatar">
